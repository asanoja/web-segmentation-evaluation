...
function getAreainCms2() {
	//por ahora siempre devuelvo 0, elementos visibles nada mas
	return 0;
}
...
function update_marco() {
	...
	s+="</tr></table>";
	s+="<form class='bommarco' id='outlinedata' name='outlinedata' method='post' action='http://localhost/BOM/endpoint.php' target='_blank'>";
	s+="<input type='hidden' class='bommarco' name='original' id='outoriginal'>";
	s+="<input type='hidden' class='bommarco' name='pageurl' id='pageurl' value='"+sourceurl+"'>";
	s+="<input type='hidden' class='bommarco' name='area' id='area' value='"+getAreainCms2()+"'>";
	s+="<input type='hidden' class='bommarco' name='granularity' id='granularity' value='"+pac+"'>";
	s+="<input type='hidden' class='bommarco' name='tcount' id='tcount' value='"+document_words+"'>";
	s+="<input type='hidden' class='bommarco' name='prima' id='outprima'>'";
	s+="<textarea class='bommarco' name='descriptor' id='descriptor' style='display:nonex'></textarea></form>";
	marco.setContent(s);
...
function update_marco_submit() {
	...
	console.log(tosend);
	document.getElementById('descriptor').value = tosend.join("##");
...
function carga(e) {
		...
		if (!cargado) {
			...
			document_words = countWords(document.body.innerText);
